...
class Remove_Course implements ActionListener{
    JFrame f;
    JTextField t;
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,id15;
    JButton b,b1,b2,b3;

    Remove_Course(){
        //various GUI components
        f=new JFrame("Remove Course");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
                //connecting to database and searching for course details with course id from user
                conn con = new conn();
                String str = "select cour_type,cour_dur,cour_name from course where cour_id ='"+t.getText()+"' ";
        ...
        if(ae.getSource()==b1){
            try{
                //connecting to database and deleting course details taking course id from user
                conn con = new conn();
                String str = "delete from COURSE where cour_id = '"+t.getText()+"'";
